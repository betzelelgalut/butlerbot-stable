...
# HACK: this class derives from IBackEnd to give it access to
# the submit() method.  the REAL back-end class is down below.
class MsnChatListener(msnp.ChatCallbacks, backend.IBackEnd):
    def __init__(self):
...
class BackEndMSN(backend.IBackEnd):
    def __init__(self):
        # Create session
    ...
    def display(self, output, user):
        ...
        print ("BackEndMSN.display() is not yet implemented")
