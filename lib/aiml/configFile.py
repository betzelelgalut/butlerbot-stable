"""
Handles the reading, writing of (and general access to) ButlerBots's
persistent configuration information, stored (by default) in
the ButlerBot.ini file.
"""
import sys, os
import string
import ConfigParser
...
configFileName = "etc/butlerbot.ini"
...
configDefaults = {
    "general.logging":              "yes",
    "general.logdir":               "var/logs",
    "general.maxdelay":             "0",
    "general.sessionspersist":      "yes",
    "general.sessionsdir":          "var/sessions",
    "general.verbose":              "yes",
    "cla.localMode":	    	    "yes",
    "cla.verboseMode":		    "no",
    }
for package in ['backends']:
    for name in eval("%s.__all__" % package): # it is having problems here locateing 'tty' in the __init_.py file in lib/plugins/connections/backends/
